"""
Chunking and embedding for paper abstracts. This is app/'s own copy -- see
mcp_server/lakebase.py's docstring for why shared modules are duplicated per
app folder rather than imported.
"""
