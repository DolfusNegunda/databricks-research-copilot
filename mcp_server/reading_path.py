...
graph -- the capstone's signature feature. Computed from data, never asked of
an LLM to guess. This is mcp_server/'s own copy -- see lakebase.py's
docstring for why shared modules are duplicated per app folder.
"""
...
def build_reading_path(
    ...
    an edge with an endpoint outside `papers` raises KeyError, deliberately.
    """
